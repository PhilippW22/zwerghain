...
<div className="hidden min-[800px]:block relative w-full" style={{ aspectRatio: '16/8' }}>
  <Image
    ...
    alt="Pommes-Waffeln im Zwerghain – Eltern-Kind-Café in Berlin-Lichterfelde"
    fill
    priority
  ...
  <div className="absolute inset-0 flex items-center">
    <div className="max-w-6xl w-full mx-auto px-8 lg:px-16">
      <div className="max-w-lg">
        ...
        Bei uns gibt es Raum zum Spielen, gemütliche Snacks für zwischendurch und natürlich unsere besonderen süßen oder herzhaften Pommes-Waffeln, die Kinderaugen zum Leuchten bringen.
        </p>
