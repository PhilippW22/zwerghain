...
export default function AboutUs() {
  ...
  return (
    <>
      <WaveDivider fromColor="#F5F5DC" toColor="#415F48" />
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
          ...
          {/* Über uns Card */}
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-12 order-1">
              ...
              <div className="flex flex-col gap-4 text-white/90 text-sm sm:text-base leading-relaxed">
                <p>
                ...
                <p className="text-white font-semibold border-l-4 border-white/60 pl-4 mt-2">
            ...
            >
              {galleryImages.map((image, index) => (
                <button
                  ...
                  className="relative aspect-square rounded-2xl overflow-hidden group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-green"
                >
                  <Image
                    src={image.src}
                    alt={image.alt}
